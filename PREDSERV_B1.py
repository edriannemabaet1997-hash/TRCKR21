...
class PredictionService:
    ...
    def _build_game(
        ...
        team_iter = [
            (away_id, away_abbr, away_name, away_team_obp, home_pitcher, home_bullpen_era, away_lineup_list, away_home_away_scalar),
            (home_id, home_abbr, home_name, home_team_obp, away_pitcher, away_bullpen_era, home_lineup_list, home_home_away_scalar),
        ]

        for team_id, team_abbr, team_name, team_obp, opp_pitcher, opp_bullpen_era, lineup_list, home_away_scalar in team_iter:
            ...
            for idx, person in enumerate(hitters, start=1):
                ...
                rbi_prob = round(clamp(1.0 - (1.0 - rbi_single) ** pa_proj, MIN_PROB, MAX_PROB), 4)
